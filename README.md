...
| Airspy Mini | ~3 MHz       | 131.525 131.550 131.725 131.825 131.850                    | `acarsdec -e --output full:file:path=acars_airspy.log,rotate=daily --airspy 0 131.525 131.550 131.725 131.825 131.850`                                                                        |
| SDRplay     | 6–8 MHz      | 131.125 131.450 131.475 131.525 131.550 131.725 131.825 131.850 | `acarsdec -e --output full:file:path=acars_sdrplay.log,rotate=daily --sdrplay 131.125 131.450 131.475 131.525 131.550 131.725 131.825 131.850`                                                |
